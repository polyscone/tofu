...
import (
	...
	"github.com/polyscone/tofu/web/api/v1/route/account"
	"github.com/polyscone/tofu/web/api/v1/route/meta"
	"github.com/polyscone/tofu/web/api/v1/route/security"
	"github.com/polyscone/tofu/web/api/v1/route/system"
