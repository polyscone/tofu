...
func TestParseBytes(t *testing.T) {
	tt := []struct {
		...
		{"bytes with negation", "-10,015", -10015},
		...
		{"kilobytes with negation", "-1,000.15 kb", -1000150},
		...
		{"megabytes with negation", "-1,000.15 mb", -1000150000},
		...
		{"gigabytes with negation", "-1,000.15 gb", -1000150000000},
		...
		{"terabytes with negation", "-1,000.15 tb", -1000150000000000},
		...
		{"petabytes with negation", "-1,000.15 pb", -1000150000000000000},
		...
		{"kibibytes with negation", "-1,000.15 kib", -1024153},

		{"mebibytes with suffix mib", "1000 mib", 1048576000},
		{"mebibytes with suffix mebibyte", "1000 mebibyte", 1048576000},
		...
		{"mebibytes with negation", "-1,000.15 mib", -1048733286},
		...
		{"gibibytes with negation", "-1,000.15 gib", -1073902885273},
		...
		{"tebibytes with negation", "-1,000.15 tib", -1099676554520166},
		...
		{"pebibytes with negation", "-1,000.15 pib", -1126068791828650368},
	}
	for _, tc := range tt {
		t.Run(tc.name, func(t *testing.T) {
