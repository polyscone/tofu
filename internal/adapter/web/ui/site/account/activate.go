...
func Activate(h *ui.Handler, mux *router.ServeMux) {
...
func activatePost(h *ui.Handler) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = h.Svc.Account.ActivateUser(ctx, email, input.Password, input.PasswordCheck)
		if err != nil {
